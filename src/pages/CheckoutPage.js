...
const CheckoutPage = () => {
    ...
    useEffect(()=> {
        ...
        let getAddress = async() =>{
            let response = await fetch(`${process.env.REACT_APP_API_URL}/api/get-address/`, {
                method:'GET',
                headers:{
                    'Content-Type':'application/json',
                    // Provide the authToken when making API request to backend to access the protected route of that user
    ...
    let addAddress = async(e) =>{
        ...
        let response = await fetch(`${process.env.REACT_APP_API_URL}/api/add-address/`, {
            method:'POST',
            headers:{
                'Content-Type':'application/json',
                // Provide the authToken when making API request to backend to access the protected route of that user
    ...
    let checkout = async() =>{
        ...
        let response = await fetch(`${process.env.REACT_APP_API_URL}/api/checkout/`, {
            method:'POST',
            headers:{
                'Content-Type':'application/json',
                // Provide the authToken when making API request to backend to access the protected route of that user
